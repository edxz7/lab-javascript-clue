...
const mysteryEnvelope  = pickMystery(charactersArray, weaponsArray, roomsArray);

console.log(Object.keys(pickMystery()).length)

// ----
{/* <FIRST NAME> <LAST NAME> killed Mr. Boddy using the <WEAPON> in the <ROOM>!!!! */}
const revealMystery = (mysteryEnvelope) => `${mysteryEnvelope['suspect'].first_name} ${mysteryEnvelope['suspect'].last_name} killed Mr. Boddy using the ${mysteryEnvelope['weapon'].name} in the ${mysteryEnvelope['room'].name}!!!!`;
